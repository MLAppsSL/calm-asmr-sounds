...
- **THEN** the profile is expected to produce installable internal Expo development client artifacts for both platforms, and any errored build blocks the foundation verification from being marked complete
