...
> Correction: Phase 5 auth is standardized on Firebase Auth and Firestore to align with the existing native setup and prior Firebase preparation. Supabase-specific wording below is stale planning drift unless and until it is fully rewritten.
